...
mkdir -p /data/MET_share/work/001_projects/proteins-crc/analysis/001_MR/002_outcome/002_exposure-cancer_outcome-proteins/

export PATH_OUT="/data/MET_share/work/001_projects/proteins-crc/code/001_MR/002_outcome/002_exposure-cancer_outcome-proteins/filelist/"
export FILE_OUT_PREFIX="filelist-"
find "${PATH_OUT}" -name "filelist-*" -type f -exec rm {} +
find "${PATH_OUT}" -name "slurm-*" -type f -exec rm {} +
# Define the directories
directories=(
"/data/GWAS_data/work/ferkingstad_2021_PMID34857953/GWAS/"
"/data/GWAS_data/work/pietzner_2021_PMID34648354/GWAS/"
"/data/GWAS_data/work/sun_2023_PMID37794186/GWAS/european/"
"/data/GWAS_data/work/sun_2023_PMID37794186/GWAS/combined/"
# "/data/GWAS_data/work/zhang_2022_PMID35501419/GWAS/european/" # only gene region available
)
...
printf "%s\n" "${files[@]}" > filenames
export FILE_IN="/data/MET_share/work/001_projects/proteins-crc/code/001_MR/002_outcome/002_exposure-cancer_outcome-proteins/filenames"
...
while IFS= read -r sh_file; do 
    ...
    awk -v fname="$base_filename" '{
        if (NR == 3) {
            print "#SBATCH --job-name=c-p_" fname;
        } else if (NR == 10) {
            print "VAR1=\"" fname "\"";
        } else {
            print $0;
