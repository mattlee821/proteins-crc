...
cd /data/MET_share/work/001_projects/proteins-crc/code/001_MR/003_harmonise/002_exposure-cancer_outcome-proteins/
mkdir -p filelist
mkdir -p /data/MET_share/work/001_projects/proteins-crc/analysis/001_MR/003_harmonise/
mkdir -p /data/MET_share/work/001_projects/proteins-crc/analysis/001_MR/003_harmonise/002_exposure-cancer_outcome-proteins/

export PATH_OUT="/data/MET_share/work/001_projects/proteins-crc/code/001_MR/003_harmonise/002_exposure-cancer_outcome-proteins/filelist/"
...
directories=(
"/data/MET_share/work/001_projects/proteins-crc/analysis/001_MR/002_outcome/002_exposure-cancer_outcome-proteins/"
)
...
printf "%s\n" "${files[@]}" > filenames
export FILE_IN="/data/MET_share/work/001_projects/proteins-crc/code/001_MR/003_harmonise/002_exposure-cancer_outcome-proteins/filenames"
...
while IFS= read -r sh_file; do 
    ...
    awk -v fname="$base_filename" '{
        if (NR == 3) {
            print "#SBATCH --job-name=harm2_" fname;
        } else if (NR == 10) {
            print "VAR1=\"" fname "\"";
        } else {
            print $0;
